...
<svelte:head>
  ...
  <link
    rel="stylesheet"
    href={`https://fonts.googleapis.com/css2?family=Material+Symbols+Rounded:opsz,wght,FILL,GRAD@48,100..700,0..1,-50..200&icon_names=${iconsToRequest.join(',')}&display=block`}
  />
</svelte:head>
